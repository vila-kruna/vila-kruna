    ...
    <>
      <section className="page-header" id="contact-header">
        <div className="container">
          ...
          <p>Book your stay quickly and easily. For additional questions, feel free to contact us.</p>
        </div>
      </section>
        ...
        <div className="container">
              ...
              <ul className="contact-details-list">
                <li className="contact-detail-item">
                  ...
                  <div className="contact-detail-text">
                    <h4 className="font-weight-bold">Our Address</h4>
                    <p>Svetozara Ivačkovića 4, Rakovica,<br />11090 Belgrade, Serbia</p>
                  </div>
                </li>
                <li className="contact-detail-item">
                  ...
                  <div className="contact-detail-text">
                    ...
                    <p>+381643339555</p>
                    <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Available on Viber and WhatsApp</p>
                  </div>
                </li>
                <li className="contact-detail-item">
                  <span className="contact-detail-icon"><i className="fa-solid fa-envelope"></i></span>
                  <div className="contact-detail-text">
                    <h4 className="font-weight-bold">Email Address</h4>
          ...
          <div className="price-note-box" style={{ marginBottom: '40px' }} id="directions-box">
            <h4 style={{ color: 'var(--primary)', marginBottom: '8px', fontWeight: 700 }}>
              <i className="fa-solid fa-diamond-turn-right" style={{ marginRight: '8px' }}></i>How to reach us?
            </h4>
            <p>
              <strong>From the Ibar highway (Ibarska magistrala), take the exit for Rakovica on the bypass road (kružni
                put)</strong>, drive straight, and after about a kilometer you will see a sign for Vila Kruna on the right side.
              Vila Kruna is located in a quiet side street with plenty of free parking space in the immediate vicinity of
              the accommodation.
            </p>
          </div>
